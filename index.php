...
?>
    <main>
                            ...
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Mixer+Grinder">Mixer Grinder</a></h3>
                                        <!-- <span>A</span> -->
                                    </div>
                                </div>
                        ...
                        <div class="single-cat text-center mb-10">
                            ...
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Hand+Blender">Hand Blender</a></h3>
                                        <!-- <span>B</span> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-cat text-center mb-10">
                            ...
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Jucier">Juicer</a></h3>
                                        <!-- <span>C</span> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-cat text-center mb-10">
                            ...
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Tower+Fan">Tower Fan</a></h3>
                                        <!-- <span>H</span> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-cat text-center mb-10">
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Pressure+Cookerr">Pressure Cooker</a></h3>
                                        <!-- <span>D</span> -->
                                    </div>
                                </div>
                                <!-- <h5><a href="services.html ">Strategy Planning </a></h5>
                        ...
                        <div class="single-cat text-center mb-10">
                            ...
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Non+Stick+Cookware">Non Stick Cookware</a></h3>
                                        <!-- <span>E</span> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-cat text-center mb-10">
                            ...
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Kictchenware">Stainless&nbsp;Steel&nbsp;Kitchenware</a></h3>
                                        <!-- <span>F</span> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-cat text-center mb-10">
                            ...
                            <div class="cat-cap ">
                                <div class="single-team ">
                                    ...
                                    <div class="team-caption ">
                                        <h3><a href="category/Gas+Stove">Gas Stove</a></h3>
                                        <!-- <span>G</span> -->
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Accessibility Code for "www.milestoneindustries.com " -->
        <script>
            (function(doc, head, body) {
                window.interdeal = {
                    sitekey: "e893ca2332e408b37de5ede4b5cd9b3f ",
                    Position: "Left ",
                    Menulang: "EN ",
                    btnStyle: {
                        icon: {
