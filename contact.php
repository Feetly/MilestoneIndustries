        ...
        <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div id="otpinfo" style="position:absolute;bottom:29%;right:43%;">
                    </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <p>Shop No. 25, 2nd Floor, Lifescape Nilay CHS Limited 11/43, Dr. B.J. Marg, Charni Road, Mumbai-400004</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                        ...
                        <!-- <h5>Factory Address:</h5><br> -->
                        <!-- <div class="media contact-info"> -->
                            <!-- <span class="contact-info__icon"><i class="ti-home"></i></span> -->
                            <!-- <div class="media-body"> -->
                                <!-- <p>Unit no. 7, Survey No. 57, H.No, 2, Goraipada, Vasai (East), District Palghar, Pincode – 401208</p> -->
                            <!-- </div> -->
                        <!-- </div> -->
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <p style="display:inline;white-space: nowrap">Customer Care: +91 9321402104</p>
                                <!-- <p>Mon to Fri 9am to 6pm</p> -->
                            </div>
                        </div>
                        <div class="media contact-info">
